...
class Employee
  @@db = SQLite3::Database.open "employee2.db"
...
class View
  def self.display_employees(employees) #to be able to input the value of employees do we not need to direct to the database within this class? Why does it work just once at the top?
